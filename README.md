...
## Accessing the ABI
If you need to use any of the contract ABIs, you can install this repo as an npm package with `npm install --dev @hollis/exchange-contracts`. Then import the ABI like so: `import { abi as IPangolinPairABI } from '@hollis/exchange-contracts/artifacts/contracts/pangolin-core/interfaces/IPangolinPair.sol/IPangolinPair.json'`.
