...
contract RewarderViaMultiplier is IRewarder {
    ...
    /// @param _rewardMultipliers The amount of each additional reward token to be claimable for every 1 base reward (HOL) being claimed
    /// @param _baseRewardTokenDecimals The decimal precision of the base reward (HOL) being emitted
    /// @param _chefV2 The address of the chef contract where the base reward (HOL) is being emitted
