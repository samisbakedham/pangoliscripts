...
class EthersAdapter {
    ...
    getSafeContract({ safeVersion, chainId, isL1SafeMasterCopy, customContractAddress }) {
        ...
        if (customContractAddress) {
            ...
            contractAddress = safeSingletonDeployment === null || safeSingletonDeployment === void 0 ? void 0 : safeSingletonDeployment.networkAddresses[chainId];
        }
        if (!contractAddress) {
    ...
    getMultiSendContract(safeVersion, chainId, customContractAddress) {
        ...
        if (customContractAddress) {
            ...
            contractAddress = multiSendDeployment === null || multiSendDeployment === void 0 ? void 0 : multiSendDeployment.networkAddresses[chainId];
        }
        if (!contractAddress) {
    ...
    getSafeProxyFactoryContract(safeVersion, chainId, customContractAddress) {
        ...
        if (customContractAddress) {
            ...
            contractAddress = proxyFactoryDeployment === null || proxyFactoryDeployment === void 0 ? void 0 : proxyFactoryDeployment.networkAddresses[chainId];
        }
        if (!contractAddress) {
    ...
    getContract(address, abi) {
        return new (__classPrivateFieldGet(this, _EthersAdapter_ethers, "f").Contract)(address, abi, __classPrivateFieldGet(this, _EthersAdapter_signer, "f"));
    }
