...
class ContractManager {
    ...
    async init({ ethAdapter, safeAddress, isL1SafeMasterCopy, contractNetworks }) {
        ...
        __classPrivateFieldSet(this, _ContractManager_safeContract, safeContract, "f");
        const multiSendContract = await ethAdapter.getMultiSendContract(safeVersion, chainId, customContracts === null || customContracts === void 0 ? void 0 : customContracts.multiSendAddress);
        ...
        __classPrivateFieldSet(this, _ContractManager_multiSendContract, multiSendContract, "f");
    }
