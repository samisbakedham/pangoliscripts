...
class Safe {
    ...
    async executeTransaction(safeTransaction, options) {
        ...
        const gasLimit = (options === null || options === void 0 ? void 0 : options.gasLimit) ||
            (await (0, gas_1.estimateGasForTransactionExecution)(__classPrivateFieldGet(this, _Safe_contractManager, "f").safeContract, signerAddress, safeTransaction));
        const executionOptions = {
            gasLimit,
            gasPrice: options === null || options === void 0 ? void 0 : options.gasPrice,
            from: signerAddress
        };
        const txResponse = await __classPrivateFieldGet(this, _Safe_contractManager, "f").safeContract.execTransaction(safeTransaction, executionOptions);
        return txResponse;
    }
}
