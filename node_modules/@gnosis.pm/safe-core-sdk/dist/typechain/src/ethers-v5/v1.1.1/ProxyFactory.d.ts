...
export declare type ProxyCreationEvent = TypedEvent<[string], {
    proxy: string;
}>;
...
export interface ProxyFactory extends BaseContract {
    ...
    functions: {
        createProxy(masterCopy: string, data: BytesLike, overrides?: Overrides & {
        ...
        createProxyWithNonce(_mastercopy: string, initializer: BytesLike, saltNonce: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        createProxyWithCallback(_mastercopy: string, initializer: BytesLike, saltNonce: BigNumberish, callback: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        calculateCreateProxyWithNonceAddress(_mastercopy: string, initializer: BytesLike, saltNonce: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    createProxy(masterCopy: string, data: BytesLike, overrides?: Overrides & {
    ...
    callStatic: {
        createProxy(masterCopy: string, data: BytesLike, overrides?: CallOverrides): Promise<string>;
        proxyRuntimeCode(overrides?: CallOverrides): Promise<string>;
        proxyCreationCode(overrides?: CallOverrides): Promise<string>;
        createProxyWithNonce(_mastercopy: string, initializer: BytesLike, saltNonce: BigNumberish, overrides?: CallOverrides): Promise<string>;
        createProxyWithCallback(_mastercopy: string, initializer: BytesLike, saltNonce: BigNumberish, callback: string, overrides?: CallOverrides): Promise<string>;
        calculateCreateProxyWithNonceAddress(_mastercopy: string, initializer: BytesLike, saltNonce: BigNumberish, overrides?: CallOverrides): Promise<string>;
    };
    filters: {
